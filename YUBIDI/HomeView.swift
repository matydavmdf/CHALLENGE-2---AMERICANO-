        ...
        NavigationStack {
            ScrollView {
                VStack(alignment: .leading, spacing: 24) {
                    ...
                    SectionView2(sectionTitle: "New songs of the week!", albums: topPicks)
                    SectionView(sectionTitle: "Your top artists", albums: recentlyPlayed)
                    SectionView2(sectionTitle: "Your top songs", albums: recommended)
                }
            }
                    ...
                    AlarmPickerView(selectedTime: $selectedTime)
                        ...
                        .toolbar {
                            ...
                            ToolbarItem(placement: .navigationBarLeading) {
                                Button { showTimerSheet = false } label: {
